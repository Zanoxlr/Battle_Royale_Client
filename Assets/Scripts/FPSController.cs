...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FPSController : MonoBehaviour
    {
        ...
        private void ProgressStepCycle(float speed)
        {
            ...
            {
                m_StepCycle += speed/7 * Time.fixedDeltaTime;
            }
        ...
        private void PlayFootStepAudio()
        {
            ...
            // pick and play a random footstep sound from the array
        ...
        {
            sensitivity = 0;
            int count = GetComponent<playersLeft>().count;
            winText.text = "You were " + count + " congrats :)";
        }
        void EscapePressed()
        {
            if (toggleMouse == true)
